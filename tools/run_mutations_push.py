#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""run_mutations_push.py — verify_push.js 의 검출력 검산.

무엇을 하나: `tools/verify_push.js --list-mutations` 로 뮤테이션 ★분모를 기계로 뽑고,
...
★주입 실패는 통과가 아니다. verify_push.js 는 셋을 가른다:
    rc=0  지목한 검사가 잡았다
...
VERIFY = os.path.join(ROOT, 'tools', 'verify_push.js')
LOCKED = os.path.join(ROOT, 'tools', 'push_locked_contracts.json')
...
def main():
    ...
    ap.add_argument('--html', default=os.path.join(ROOT, 'push', 'index.html'))
