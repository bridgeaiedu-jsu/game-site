...
export const GAMES = ['block-puzzle', '2048', 'block-drop', 'word', 'shooting', 'brick-breaker', 'estimate', 'sudoku', 'nonsense', 'wordchain', 'minesweeper', 'ladder', 'memory', 'nonogram', 'tensec', 'stop', 'just-right', 'fake-one', 'reverse', 'higher-lower', 'how-many', 'together', 'gomoku', 'bomb', 'push', 'four', 'quick-math', 'number-baseball', 'mole', 'chosung', 'saja', 'hanbut', 'dolryeo', 'talchul', 'gyuchik', 'dari'];
